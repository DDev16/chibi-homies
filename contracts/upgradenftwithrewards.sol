...
contract NFTMintingContract is Initializable, UUPSUpgradeable, OwnableUpgradeable, ERC721EnumerableUpgradeable {
   ...
   function mint(uint256 _mintAmount) public payable {
    ...
    function withdrawOwnerShare() public onlyOwner {
